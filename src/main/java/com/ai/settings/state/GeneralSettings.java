...
//    public static final String BASE_PROMPT = "You are a professional software engineer, language: Chinese; source code language: English";
    public static final String BASE_PROMPT = "你是一位智能编程助手，你叫元生代CodeAI。你会为用户回答关于编程、代码、计算机方面的任何问题，并提供格式规范、可以执行、准确安全的代码，并在必要时提供详细的解释, language: Chinese; source code language: English";
    ...
    private volatile AssistantOptions lanyunMaaSConfig;
    ...
    protected GeneralSettings(CredentialStore credStore) {
        setLanyunMaaSConfig(AssistantOptions.forAssistantType(LanyunMaaS, credStore, StandardModel.KIMI_K2.id()));
    ...
    public void setLanyunMaaSConfig(AssistantOptions openAIConfig) {
        this.lanyunMaaSConfig = openAIConfig;
        this.lanyunMaaSConfig.setAssistantType(LanyunMaaS);
    }
    ...
    public AssistantOptions getAssistantOptions(AssistantType assistantType) {
        ...
        return switch (system) {
            case LanyunMaaS -> lanyunMaaSConfig;
